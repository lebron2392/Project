...
use models\examples\project\PartPaginator5 as PartPaginatorModel;
use views\examples\project\P5 as PartListView;
...
class PartPaginatorSorter5 extends Controller
{
    /**
    * Object constructor.
    *
    ...
    */
    ...
    {
        $view = new PartListView("/examples/project/part_paginator_sorter5");
        return $view;
    }
