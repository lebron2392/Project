...
use models\examples\Project\AllocationTaskOdl as PartRecordModel;
...
class AllocationTaskOdl extends Controller
{
    protected $view;
    protected $model;
    ...
    protected function autorun($parameters = null)
    {
        ...
        $this->model->makeIDTaskList($this->view);
        $this->model->makeIDOdlList($this->view);
    ...
    */
    ...
    {
        $view = new PartRecordView("/examples/Project/allocation_task_odl");
        return $view;
    }
