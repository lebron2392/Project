...
use models\examples\project\AllOrderTaskList as PartListModel;
use views\examples\project\AllOrderTaskList as PartListView;
use framework\components\DataRepeater;


class AllOrderTaskList extends Controller
{
    ...
    {
        $view = new PartListView("/examples/project/all_order_task_list");
        return $view;
    }
