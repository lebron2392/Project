...
<div class="container">
    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-proj">
            <div class="panel-heading" role="tab" id="headingProj">
                <h4 class="panel-title">
                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Proj"  aria-controls="collapseThree">
                        Project
                    </a>
                </h4>
            </div>
            <div id="Proj" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                <div class="panel-body">
                    <ul>
                        <li><a href="project/part_paginator_sorter_search">OdL worker download</li>
                    </ul>
                </div>
            </div>
        </div>
